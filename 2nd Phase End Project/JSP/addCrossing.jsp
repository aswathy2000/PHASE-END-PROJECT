...
<body>
		...
		<h3 style="color: gray"><b> Add Railway Crossing Information </b></h3>
		</div>
		
		<div style="align-self: left; margin-left: 40%">
		
		<form action="addController" method="post" style=" padding: 10px;">
		...
		<input type="submit" value="Submit" style="background-color: green; border:none; border-radius:10px; color:white;  padding: 10px  122px">
		</form>
