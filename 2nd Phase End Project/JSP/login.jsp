...
<body>
		...
		<h3 style="color: gray"><b> User Login </b></h3>		
		<br><br>
		   ...
		   <form action="loginValidate" method="post">
		       ...
		       <br><br><input type="submit" value="Login" style="background-color: green; border:none; border-radius:10px; color:white;  padding: 10px  80px">
		   </form>
